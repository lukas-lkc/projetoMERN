...
const generateToken = (id) => 
    jwt.sign({id: id}, process.env.SECRET, {expiresIn: 86400}); //{expiresIn: 86400} é uma opção para definir o tempo de autenticação, ou seja, o tempo que o token vai ser válido. o valor representa 24h em segundos
